 ...
 * @ApiGroup(groupName="/Api.Mj")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class Mj extends AnnotationController
{
	/**
	 * @Api(name="add",path="/Api/Mj/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/Mj/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/Mj/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/Mj/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/Mj/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
