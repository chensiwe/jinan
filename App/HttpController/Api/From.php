 ...
 * @ApiGroup(groupName="/Api.From")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class From extends AnnotationController
{
	/**
	 * @Api(name="add",path="/Api/From/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/From/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/From/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/From/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/From/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
