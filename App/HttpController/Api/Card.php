 ...
 * @ApiGroup(groupName="/Api.Card")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class Card extends AnnotationController
{
	/**
	 * @Api(name="add",path="/Api/Card/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/Card/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/Card/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/Card/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/Card/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
