 ...
 * @ApiGroup(groupName="/Api.SupplyType")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class SupplyType extends AnnotationController
{
	/**
	 * @Api(name="add",path="/Api/SupplyType/add")
	 * @ApiDescription("新增数据")
	...
	public function add()
	{
		...
		$model = new SupplyTypeModel($data);
		$model->save();
	...
	/**
	 * @Api(name="update",path="/Api/SupplyType/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/SupplyType/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/SupplyType/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/SupplyType/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
