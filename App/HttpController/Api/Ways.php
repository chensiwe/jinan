 ...
 * @ApiGroup(groupName="/Api.Ways")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class Ways extends AnnotationController
{
	/**
	 * @Api(name="add",path="/Api/Ways/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/Ways/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/Ways/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/Ways/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/Ways/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
