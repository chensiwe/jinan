 ...
 * @ApiGroup(groupName="/Api.Gb")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class Gb extends AnnotationController
{
	/**
	 * @Api(name="add",path="/Api/Gb/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/Gb/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/Gb/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/Gb/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/Gb/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
